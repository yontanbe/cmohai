      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400 text-sm">Marketing Consulting</li>
              <li className="text-gray-400 text-sm">Lead Generation</li>
              <li className="text-gray-400 text-sm">LinkedIn Automation</li>
              <li className="text-gray-400 text-sm">AI Chatbots</li>
              <li className="text-gray-400 text-sm">Revenue Operations</li>
            </ul>
          </div>
        </div>
