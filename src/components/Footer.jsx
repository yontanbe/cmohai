    ...
    <footer className="w-full bg-black border-t border-gray-800 py-16">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="mb-12">
          ...
          <div className="flex justify-center space-x-6">
            <a
              ...
              className="w-12 h-12 bg-gray-900 border border-gray-800 hover:border-purple-500 rounded-xl flex items-center justify-center transition-all hover:scale-110"
            >
        ...
        <div className="flex flex-wrap gap-8 justify-center mb-12">
          ...
          <button onClick={() => scrollToSection('tools')} className="text-gray-400 hover:text-white transition-colors">Tools</button>
        ...
        <div className="border-t border-gray-800 pt-8">
          ...
          <button onClick={scrollToTop} className="inline-flex items-center space-x-2 text-gray-400 hover:text-white transition-colors">
