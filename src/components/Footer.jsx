export default function Footer() {
  ...
  return (
    <footer className="bg-gray-950 border-t border-gray-800 w-full flex items-center justify-center">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-12 w-full max-w-7xl">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8 text-center sm:text-left">
          ...
          <div className="flex flex-col items-center sm:items-start">
            <h3 className="text-white font-bold text-base md:text-lg mb-4">Quick Links</h3>
          ...
          {/* Services */}
          <div className="flex flex-col items-center sm:items-start">
            <h3 className="text-white font-bold text-base md:text-lg mb-4">Services</h3>
            <ul className="space-y-2">
              <li className="text-gray-400 text-xs md:text-sm">Marketing Consulting</li>
              <li className="text-gray-400 text-xs md:text-sm">Lead Generation</li>
              <li className="text-gray-400 text-xs md:text-sm">LinkedIn Automation</li>
              <li className="text-gray-400 text-xs md:text-sm">AI Chatbots</li>
              <li className="text-gray-400 text-xs md:text-sm">Revenue Operations</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          >
            ...
            <svg
              className="w-3 h-3 md:w-4 md:h-4 group-hover:-translate-y-1 transition-transform"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
